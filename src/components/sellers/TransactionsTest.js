...
import { getUserTransactionsTest } from "../../redux/actions/transactionActions";
...
function TransactionsTest() {
  ...
  useEffect(() => {
    dispatch(getUserTransactionsTest());
  }, [dispatch]);

  return (
    <div>
      <h1 className="text-center py-3">
        <i className="fas fa-money-check-alt"></i> Test Transactions
      </h1>
      {loading ? (
        <Loader />
      ) : error ? (
