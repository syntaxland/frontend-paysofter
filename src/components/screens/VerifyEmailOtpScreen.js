...
import { verifyEmailOtp, resendEmailOtp } from "../../redux/actions/emailOtpActions";
...
const VerifyEmailOtpScreen = () => { 
  ...
  const { loading: profileLoading, success: profileSuccess, profile, error: profileError } = userProfile;
  console.log("VerifyEmailOtpScreen profile:", profile);
