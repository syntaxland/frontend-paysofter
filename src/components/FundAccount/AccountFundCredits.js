...
function AccountFundCredits() {
  ...
  const { loading, accountFunds, error } = getUserAccountFundCreditsState;
  ...
  useEffect(() => {
    dispatch(getUserAccountFundCredits());
  }, [dispatch]);
...
export default AccountFundCredits;
